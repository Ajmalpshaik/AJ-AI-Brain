...
| **Will these scripts run on Revit 2024/2025/2026+** — what breaks when the Revit version moves, which .NET goes with which release, how many of the 311 fragments are affected | [`revit-version-compatibility.md`](revit-version-compatibility.md) |
