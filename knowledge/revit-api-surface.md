...
Generated from the 290 fragments on 2026-08-22 — **not** copied from documentation. Regenerate with the
...
| Types the 290 fragments actually use | **245** |
...
knows because it learned them the hard way. The fragments are **290 proven working examples**; the value
...
|---|---|---|
| `Document` | 240 | `actions/color-graphics/action-apply-view-filter.cs`, `actions/color-graphics/action-color-by-group.cs`, `actions/color-graphics/action-create-selection-filter.cs` |
| `Transaction` | 162 | `actions/color-graphics/action-apply-view-filter.cs`, `actions/color-graphics/action-color-by-group.cs`, `actions/color-graphics/action-create-selection-filter.cs` |
| `FilteredElementCollector` | 155 | `actions/color-graphics/action-apply-view-filter.cs`, `actions/color-graphics/action-color-by-group.cs`, `actions/color-graphics/action-create-selection-filter.cs` |
| `ElementId` | 139 | `actions/color-graphics/action-apply-view-filter.cs`, `actions/color-graphics/action-color-by-group.cs`, `actions/color-graphics/action-create-view-filter.cs` |
| `Element` | 130 | `actions/color-graphics/action-color-by-group.cs`, `actions/move-copy-rotate/action-align-elements.cs`, `actions/move-copy-rotate/action-move-elements.cs` |
| `View` | 73 | `actions/color-graphics/action-apply-view-filter.cs`, `actions/color-graphics/action-color-by-group.cs`, `actions/color-graphics/action-highlight-vs-rest.cs` |
| `BuiltInParameter` | 48 | `actions/color-graphics/action-color-by-group.cs`, `actions/parameters-naming/action-set-element-phase.cs`, `actions/parameters-naming/action-set-workset.cs` |
| `BuiltInCategory` | 46 | `actions/color-graphics/action-create-view-filter.cs`, `actions/reporting/action-count-by-spatial-container.cs`, `actions/reporting/action-report-coverage.cs` |
| `FamilyInstance` | 31 | `actions/move-copy-rotate/action-flip-elements.cs`, `actions/parameters-naming/action-rename-family.cs`, `actions/reporting/action-count-by-group.cs` |
...
| `Level` | 26 | `context/context-levels-and-grids.cs`, `context/context-session-start.cs`, `creators/create-cable-tray.cs` |
...
| `Connector` | 17 | `actions/move-copy-rotate/action-fillet-elements.cs`, `actions/reporting/action-report-connectors.cs`, `actions/structural-changes/action-place-accessory-on-run.cs` |
...
| `Category` | 14 | `actions/color-graphics/action-report-category-overrides.cs`, `actions/move-copy-rotate/action-move-to-ray-hit.cs`, `actions/qa-checks/action-check-surface-fit.cs` |
...
| `InvalidOperationException` | 12 | `actions/color-graphics/action-create-view-filter.cs`, `actions/parameters-naming/action-add-project-parameter.cs`, `actions/sheets-views/action-duplicate-view-template.cs` |
| `MEPCurve` | 11 | `actions/move-copy-rotate/action-fillet-elements.cs`, `actions/reporting/action-report-connectors.cs`, `actions/structural-changes/action-place-accessory-on-run.cs` |
| `Curve` | 10 | `actions/structural-changes/action-extract-cad-curves.cs`, `creators/create-filled-region.cs`, `creators/create-floor.cs` |
...
| `FilterElement` | 7 | `actions/color-graphics/action-apply-view-filter.cs`, `actions/color-graphics/action-remove-view-filter.cs`, `actions/color-graphics/action-report-view-filters.cs` |
...
| `SelectionFilterElement` | 5 | `actions/color-graphics/action-create-selection-filter.cs`, `actions/color-graphics/action-report-view-filters.cs`, `actions/reporting/action-test-view-filter-match.cs` |
...
| `Type` | 5 | `actions/reporting/action-report-parameter-inventory.cs`, `context/context-project-units.cs`, `context/harvest-revit-api.cs` |
...
| `ParameterFilterElement` | 4 | `actions/color-graphics/action-create-view-filter.cs`, `actions/color-graphics/action-report-view-filters.cs`, `actions/reporting/action-test-view-filter-match.cs` |
...
| `TemporaryViewMode` | 4 | `actions/visibility/action-isolate-elements.cs`, `actions/visibility/action-manage-named-set.cs`, `commands/unhide-all-active-view.cs` |
...
| `CurveLoop` | 3 | `creators/create-filled-region.cs`, `creators/create-floor.cs`, `filters/by-location/filter-by-solid-intersection.cs` |
...
| `Queue` | 3 | `filters/by-relationship/filter-by-subcomponents.cs`, `recipes/sprinkler-pipe-schedule-size.cs`, `recipes/verify-duct-connectivity.cs` |
...
| `Definition` | 2 | `actions/parameters-naming/action-add-project-parameter.cs`, `actions/reporting/action-report-parameter-inventory.cs` |
...
| `FamilyManager` | 2 | `recipes/create-equipment-family-from-datasheet.cs`, `recipes/create-parametric-box-family-with-duct-connector.cs` |
| `FamilyParameter` | 2 | `recipes/create-equipment-family-from-datasheet.cs`, `recipes/create-parametric-box-family-with-duct-connector.cs` |
...
| `LabelUtils` | 2 | `actions/reporting/action-report-parameter-inventory.cs`, `context/context-project-units.cs` |
...
| `Reset` | 2 | `actions/visibility/action-hide-elements.cs`, `actions/visibility/action-manage-named-set.cs` |
...
| `UNCONFIRMED` | 2 | `recipes/sprinkler-adjust-for-obstructions.cs`, `recipes/sprinkler-pipe-schedule-size.cs` |
| `UnitUtils` | 2 | `context/context-project-units.cs`, `recipes/create-equipment-family-from-datasheet.cs` |
...
| `Binding` | 1 | `actions/parameters-naming/action-add-project-parameter.cs` |
| `BindingMap` | 1 | `actions/parameters-naming/action-add-project-parameter.cs` |
...
| `FilterRule` | 1 | `actions/color-graphics/action-create-view-filter.cs` |
| `FitDirection` | 1 | `actions/sheets-views/action-export-view-image.cs` |
| `Floor` | 1 | `creators/create-floor.cs` |
| `FloorType` | 1 | `creators/create-floor.cs` |
| `FormatOptions` | 1 | `context/context-project-units.cs` |
...
| `GroupNameOf` | 1 | `actions/reporting/action-report-parameter-inventory.cs` |
...
| `LOOPED` | 1 | `recipes/sprinkler-pipe-schedule-size.cs` |
...
| `MIXED` | 1 | `recipes/sprinkler-set-room-hazard.cs` |
...
| `ParameterFilterRuleFactory` | 1 | `actions/color-graphics/action-create-view-filter.cs` |
...
| `SpaceSet` | 1 | `creators/create-hvac-zone.cs` |
...
| `TaggedIdOf` | 1 | `recipes/tag-elements-in-active-view.cs` |
| `Title` | 1 | `actions/sheets-views/action-export-schedule-to-csv.cs` |
| `ToInternal` | 1 | `recipes/create-equipment-family-from-datasheet.cs` |
...
| `UnitOf` | 1 | `context/context-project-units.cs` |
| `Units` | 1 | `context/context-project-units.cs` |
...
## BuiltInParameter values in use (69)

`RBS_CURVE_HEIGHT_PARAM`, `RBS_CURVE_WIDTH_PARAM`, `EXTRUSION_END_PARAM`, `FAMILY_LEVEL_PARAM`, `INSTANCE_REFERENCE_LEVEL_PARAM`, `LEVEL_PARAM`, `RBS_START_LEVEL_PARAM`, `SCHEDULE_LEVEL_PARAM`, `CEILING_HEIGHTABOVELEVEL_PARAM`, `EXTRUSION_START_PARAM`, `RBS_CURVE_DIAMETER_PARAM`, `RBS_DUCT_SYSTEM_TYPE_PARAM`, `RBS_PIPE_DIAMETER_PARAM`, `ALL_MODEL_MARK`, `RBS_DUCT_FLOW_PARAM`, `RBS_SYSTEM_NAME_PARAM`, `ROOM_NAME`, `ALL_MODEL_FAMILY_NAME`, `BASEPOINT_ANGLETON_PARAM`, `CURVE_ELEM_LENGTH`, `RBS_CABLETRAY_HEIGHT_PARAM`, `RBS_CABLETRAY_WIDTH_PARAM`, `RBS_CONDUIT_DIAMETER_PARAM`, `ROOM_DESIGN_RETURN_AIRFLOW_PARAM`, `ROOM_DESIGN_SUPPLY_AIRFLOW_PARAM`, `SYMBOL_FAMILY_NAME_PARAM`, `VIEWER_VOLUME_OF_INTEREST_CROP`, `BASEPOINT_EASTWEST_PARAM`, `BASEPOINT_ELEVATION_PARAM`, `BASEPOINT_NORTHSOUTH_PARAM`, `CLIENT_NAME`, `CONNECTOR_DIAMETER`, `CONNECTOR_HEIGHT`, `CONNECTOR_WIDTH`, `ELEM_PARTITION_PARAM`, `FAMILY_CONTENT_PART_TYPE`, `FLOOR_PARAM_IS_STRUCTURAL`, `INVALID`, `IS_VISIBLE_PARAM`, `LEADER_OFFSET_SHEET`, `LEVEL_ELEV`, `LINE_COLOR`, `OPTION_SET_ID`, `PHASE_CREATED`, `PHASE_DEMOLISHED`, `PROJECT_NAME`, `PROJECT_NUMBER`, `PROJECT_STATUS`, `RBS_CALCULATED_SIZE`, `RBS_ELEC_APPARENT_LOAD`, `RBS_ELEC_NUMBER_OF_POLES`, `RBS_ELEC_VOLTAGE`, `RBS_PIPE_FLOW_DIRECTION_PARAM`, `RBS_PIPING_SYSTEM_TYPE_PARAM`, `RBS_SYSTEM_ABBREVIATION_PARAM`, `ROOM_NUMBER`, `ROOM_VOLUME`, `TEXT_BACKGROUND`, `TEXT_BOX_VISIBILITY`, `TEXT_FONT`, `TEXT_SIZE`, `TEXT_STYLE_BOLD`, `TEXT_STYLE_ITALIC`, `TEXT_STYLE_UNDERLINE`, `TEXT_WIDTH_SCALE`, `VIEW_PHASE`, `VIEW_PHASE_FILTER`, `VIEW_SCALE`, `VIEWER_ANNOTATION_CROP_ACTIVE`

## BuiltInCategory values in use (41)

`OST_DuctCurves`, `OST_DuctTerminal`, `OST_PipeCurves`, `OST_Rooms`, `OST_PipeFitting`, `OST_DuctAccessory`, `OST_DuctFitting`, `OST_TitleBlocks`, `OST_FlexDuctCurves`, `OST_MEPSpaces`, `OST_VolumeOfInterest`, `OST_MechanicalEquipment`, `OST_Sprinklers`, `OST_StructuralFraming`, `OST_CableTray`, `OST_Ceilings`, `OST_Columns`, `OST_Conduit`, `OST_Doors`, `OST_LightingFixtures`, `OST_StructuralColumns`, `OST_DuctInsulations`, `OST_DuctLinings`, `OST_DuctTags`, `OST_FlexPipeCurves`, `OST_Floors`, `OST_Lines`, `OST_PipeAccessory`, `OST_Walls`, `OST_CableTrayFitting`, `OST_CalloutBoundary`, `OST_Callouts`, `OST_CLines`, `OST_Coupler`, `OST_Furniture`, `OST_Grids`, `OST_Levels`, `OST_Matchline`, `OST_PipeInsulations`, `OST_Rebar`, `OST_Windows`
