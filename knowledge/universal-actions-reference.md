...
62. Join Geometry
63. Unjoin Geometry
64. Array – BUILT: `actions/move-copy-rotate/action-array-elements.cs` (live-verified 2026-07-22, linear + radial, exact numeric match)
65. Align Elements – BUILT: `actions/move-copy-rotate/action-align-elements.cs` (live-verified 2026-07-22, exact match)
...
101. Create View Template from View — BUILT: `actions/sheets-views/action-create-view-template-from-view.cs` (live-verified 2026-07-22)
102. Set View Template Parameter Include/Exclude — BUILT: `actions/sheets-views/action-set-view-template-controlled-params.cs` (live-verified 2026-07-22)
103. Set View Scale
