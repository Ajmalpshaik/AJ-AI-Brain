...
// PURPOSE: Use whatever the user currently has selected in Revit as the element set — for "do this to
...
if (elements.Count == 0)
{
    sb.AppendLine("Nothing is selected in Revit right now — ask the user to select elements first.");
}
