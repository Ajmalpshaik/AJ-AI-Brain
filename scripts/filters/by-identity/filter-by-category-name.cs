...
//          member — more dictation-friendly, since the user names categories in plain words, not enum
//          identifiers. Prefer filter-by-category.cs when the BuiltInCategory is already known; use
//          this one when working straight from the user's own wording and you'd otherwise have to guess
//          the enum name.
