...
// PURPOSE: Report selected parameter values for `elements` as a small table. Use this when the user asks
...
{
    sb.AppendLine($"... {elements.Count - maxRows} more element(s) not shown. Increase maxRows only if the user asks for the full table.");
}
