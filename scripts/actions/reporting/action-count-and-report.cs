...
//          when asked for sizes. Read-only, no transaction needed. If the user asked about one specific
...
bool wantBreakdownTable = false; // true only when the user actually asked for sizes/breakdown
// If the user asked about ONE specific dimension (e.g. "what height"), put it here so it's tried first —
