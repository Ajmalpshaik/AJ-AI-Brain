...
`semantic-index\ask-brain-hybrid.cmd "how do I stop ducts overlapping the ceiling"` searches all 443 files
...
- **"It errors on a newer Revit."** `tools\check-scripts.cmd` compile-checks all 366 fragments against
