...
`semantic-index\ask-brain-hybrid.cmd "how do I stop ducts overlapping the ceiling"` searches all 381 files
...
- **"It errors on a newer Revit."** `tools\check-scripts.cmd` compile-checks all 311 fragments against
