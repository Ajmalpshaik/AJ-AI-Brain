...
The 388 fragments in `scripts/` were proven one at a time against a real model. Until this tool, none of
...
now also have a native tool above), and the 388 real C# fragments in `scripts/` (51 filters, 237
